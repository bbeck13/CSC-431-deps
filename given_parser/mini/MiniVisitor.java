...
public interface MiniVisitor<T> extends ParseTreeVisitor<T> {
   ...
   /**
    * Visit a parse tree produced by the {@code IntType} labeled alternative in
   ...
   /**
    * Visit a parse tree produced by the {@code BoolType} labeled alternative in
    * {@link MiniParser#type}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code StructType} labeled alternative
   ...
   /**
    * Visit a parse tree produced by the {@code ReturnTypeReal} labeled
   ...
   /**
    * Visit a parse tree produced by the {@code ReturnTypeVoid} labeled
    * alternative in {@link MiniParser#returnType}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code NestedBlock} labeled alternative
   ...
   /**
    * Visit a parse tree produced by the {@code Assignment} labeled alternative
    * in {@link MiniParser#statement}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code Print} labeled alternative in
   ...
   /**
    * Visit a parse tree produced by the {@code PrintLn} labeled alternative in
    * {@link MiniParser#statement}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code Conditional} labeled alternative
    * in {@link MiniParser#statement}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code Delete} labeled alternative in
    * {@link MiniParser#statement}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code Invocation} labeled alternative
    * in {@link MiniParser#statement}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code LvalueId} labeled alternative in
   ...
   /**
    * Visit a parse tree produced by the {@code LvalueDot} labeled alternative
   ...
   /**
    * Visit a parse tree produced by the {@code IntegerExpr} labeled alternative
   ...
   /**
    * Visit a parse tree produced by the {@code TrueExpr} labeled alternative in
   ...
   /**
    * Visit a parse tree produced by the {@code IdentifierExpr} labeled
   ...
   /**
    * Visit a parse tree produced by the {@code BinaryExpr} labeled alternative
    * in {@link MiniParser#expression}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code NewExpr} labeled alternative in
    * {@link MiniParser#expression}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code NestedExpr} labeled alternative
    * in {@link MiniParser#expression}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code DotExpr} labeled alternative in
    * {@link MiniParser#expression}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code UnaryExpr} labeled alternative
    * in {@link MiniParser#expression}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code InvocationExpr} labeled
    * alternative in {@link MiniParser#expression}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code FalseExpr} labeled alternative
    * in {@link MiniParser#expression}.
    * 
    * @param ctx
    *           the parse tree
   ...
   /**
    * Visit a parse tree produced by the {@code NullExpr} labeled alternative in
    * {@link MiniParser#expression}.
    * 
    * @param ctx
    *           the parse tree
